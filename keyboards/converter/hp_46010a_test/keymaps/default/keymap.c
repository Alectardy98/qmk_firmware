...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        RESET, DEBUG,   KC_F1, KC_F2, KC_F3, KC_F4,KC_NO,  KC_NO,   KC_F5, KC_F6, KC_F7, KC_F8,                   KC_NO,   KC_NO,     KC_F9,   KC_F10,  KC_F11,  KC_F12,  \
        ...
        KC_LGUI,      KC_L,         KC_LALT,              KC_SPACE                    ,               KC_RALT,KC_R, KC_LEFT, KC_DOWN, KC_RGHT,        KC_P0,       KC_PDOT           \
    )
} ;
