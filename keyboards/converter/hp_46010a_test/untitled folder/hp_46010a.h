...
#define LAYOUT( \
    ...
    KEY_PRNT, KEY_LEXTRA,              KEY_LALT,            KEY_SPACE,                       KEY_RALT, KEY_REXTRA, KEY_LEFT, KEY_DOWN, KEY_RGHT,        KEY_P0,       KEY_PDOT           \
) { \
    ...
    {KEY_SPACE, KEY_LALT, KEY_RALT, KEY_REXTRA,KEY_LEFT, KEY_DOWN, KEY_RGHT, KC_NO   }, \
    ...
    {KEY_RES,   KEY_F,    KEY_D,    KEY_S,    KEY_A,    KEY_LEXTRA,    KEY_2,    KEY_H    }, \
